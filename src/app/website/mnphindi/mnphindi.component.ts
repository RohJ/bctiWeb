...
@Component({
  selector: 'app-mnphindi',
  templateUrl: './mnphindi.component.html',
  styleUrl: './mnphindi.component.scss'
})
export class MnphindiComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    new Glide(".testimony_cards_mnp_hindi", {
      type: "carousel",
      startAt: 0,
      focusAt: 0,
      // perTouch: 1,
